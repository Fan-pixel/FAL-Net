...
parser.add_argument('--model_save_dir', type=str, default='/home/ubuntu/AFre-Net-train/save_model')
...
if args.type == 0:
    ...
    args.test_dir = "/home/ubuntu/AFre-Net-train/datasets_test/densehaze/"
    args.test_name = 'input,gt'
    tag = 'dense'
elif args.type == 4:
    args.test_dir = "/home/ubuntu/AFre-Net-train/datasets_test/NHhaze/"
    args.test_name = 'input,gt'
    tag = 'nhhaze'
elif args.type == 5:
    args.test_dir = "/home/ubuntu/AFre-Net-train/datasets_test/outdoor/"
    ...
    args.test_dir = "/home/ubuntu/AFre-Net-train/datasets_test/RTTS/"
    tag = 'RTTS'
elif args.type == 8:
    args.test_dir = "/home/ubuntu/AFre-Net-train/datasets_test/RW2AH/"
    args.test_name = 'input,gt'
    tag = 'RW2AH'
...
with torch.no_grad():
    ...
    for (hazy, clean, name) in test_loader:
        ...
        hazy = hazy[:, :3, :, :].to(device)
        clean = clean[:, :3, :, :].to(device)
